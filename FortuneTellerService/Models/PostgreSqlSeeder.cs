...
internal sealed class PostgreSqlSeeder
{
    ...
    private static async Task InsertSampleDataAsync(FortuneContext fortuneDbContext)
    {
        fortuneDbContext.Fortunes.AddRange(
            new() { Id = 1000, Text = "People are naturally attracted to you." },
            ...
            new() { Id = 1003, Text = "What ever you're goal is in life, embrace it visualize it, and for it will be yours." },
            new() { Id = 1004, Text = "Your shoes will make you happy today." },
            new() { Id = 1005, Text = "You cannot love life until you live the life you love." },
            new() { Id = 1006, Text = "Be on the lookout for coming events; They cast their shadows beforehand." },
            new() { Id = 1007, Text = "Land is always on the mind of a flying bird." },
            ...
            new() { Id = 1010, Text = "A dream you have will come true." },
            new() { Id = 1011, Text = "Our deeds determine us, as much as we determine our deeds." },
            new() { Id = 1012, Text = "Never give up. You're not a failure if you don't give up." },
            new() { Id = 1013, Text = "You will become great if you believe in yourself." },
            new() { Id = 1014, Text = "There is no greater pleasure than seeing your loved ones prosper." },
            ...
            new() { Id = 1030, Text = "If winter comes, can spring be far behind?" },
            ...
            new() { Id = 1034, Text = "A new voyage will fill your life with untold memories." },
            ...
            new() { Id = 1038, Text = "Its amazing how much good you can do if you don't care who gets the credit." },
            ...
            new() { Id = 1042, Text = "It''s better to be alone sometimes." },
